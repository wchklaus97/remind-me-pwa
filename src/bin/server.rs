...
impl AssetIndex {
    fn new(public_dir: PathBuf, base_path: String) -> Self {
        ...
        for (k, prefix, ext) in [
            ...
            ("app-base.css", "app-base-", ".css"),
            ("app-reminders.css", "app-reminders-", ".css"),
            ("app-view-variants.css", "app-view-variants-", ".css"),
            ("app-calendar.css", "app-calendar-", ".css"),
            ("app-tags.css", "app-tags-", ".css"),
            ("app-extras.css", "app-extras-", ".css"),
